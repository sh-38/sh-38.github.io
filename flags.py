...
for code in file_codes:
    if code not in country_codes:
        print("Code not found in source/country.json:", code)
        all_good = False
...
if all_good:
    print("All flag icons and source/country.json are in sync.")
    exit(0)
exit(1)
